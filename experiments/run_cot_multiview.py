"""
Multi-Viewpoint Pipeline Experiment Runner.
"""
import argparse
import sys
...
from src.pipelines.multiview import MultiViewPipeline
...
def main():
    ...
    pipeline = MultiViewPipeline(llm_provider=llm, temperature=args.temperature)
