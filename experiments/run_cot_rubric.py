"""
Rubric Filtered Pipeline Experiment Runner.
"""
import argparse
import sys
...
from src.pipelines.rubric import RubricPipeline
...
def main():
    ...
    pipeline = RubricPipeline(llm_provider=llm, temperature=args.temperature)
