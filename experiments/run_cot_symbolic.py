"""
Symbolic Trace Pipeline Experiment Runner.
"""
import argparse
import sys
...
from src.pipelines.symbolic import SymbolicTracePipeline
...
def main():
    ...
    pipeline = SymbolicTracePipeline(llm_provider=llm, temperature=args.temperature)
